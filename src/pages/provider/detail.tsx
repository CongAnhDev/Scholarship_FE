                    ...
                    {ProviderDetail && ProviderDetail._id &&
                        <>
                            <Row gutter={[10, 10]} className={styles["custom-row"]}>
                                ...
                                /></Col>
                                <Col span={16} style={{ color: '#353535', fontSize: '27px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700 }}><div>
                                    {ProviderDetail.name}
                                </div></Col>
...
<h3
                            ...
                            <Col span={24} md={8}>
                                <div style={{ height: 350 ,position:'relative',display: 'flex', flexDirection: 'column',justifyContent: 'space-between'}}>
                                    <div>
                                        <img
                                            alt="example"
                                            src={`${import.meta.env.VITE_BACKEND_URL}/images/Provider/${ProviderDetail?.logo}`}
